...
module attributes {atli.certified_beta_slots = 1 : i64, atli.arena_overhead_slots = 0 : i64} {
  ...
  func.func @atli_fn_counter(%n: i64) -> i64 {
    ...
    %hcase2 = scf.if %is_zero1 -> (i64) {
      %c3 = arith.constant 0 : i64
      scf.yield %c3 : i64
    } else {
      %c4 = arith.constant 1 : i64
      %pred5 = arith.subi %n, %c4 : i64
      %call6 = func.call @atli_fn_counter(%pred5) : (i64) -> i64
      // H-op-resume, calculus.md §5; static dispatch licensed by L5_mentions_iff_resume
      %c7 = arith.constant 1 : i64
      %add8 = arith.addi %call6, %c7 : i64
      %resume_uses9 = arith.constant 1 : i64
      func.call @atli_debug_resume_once(%resume_uses9) : (i64) -> ()
      scf.yield %add8 : i64
    }
    return %hcase2 : i64
  }
