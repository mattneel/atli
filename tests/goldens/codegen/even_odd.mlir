...
module attributes {atli.certified_beta_slots = 2 : i64, atli.arena_overhead_slots = 0 : i64, atli.growable = false} {
  llvm.func @atli_entry_even(i64) -> i64
  llvm.func @atli_entry_odd(i64) -> i64
  ...
  func.func @atli_fn_even(%n: i64) -> i64 {
    ...
    %case2 = scf.if %is_zero1 -> (i64) {
      ...
      %call6 = func.call @atli_fn_odd(%pred5) : (i64) -> i64
      scf.yield %call6 : i64
    }
    return %case2 : i64
  }
  func.func @atli_fn_odd(%n: i64) -> i64 {
    %frame = arith.constant 1 : i64
    func.call @atli_touch_frame(%frame) : (i64) -> ()
    %c0 = arith.constant 0 : i64
    %is_zero1 = arith.cmpi eq, %n, %c0 : i64
    %case2 = scf.if %is_zero1 -> (i64) {
      ...
      %c4 = arith.constant 1 : i64
      %pred5 = arith.subi %n, %c4 : i64
      %call6 = func.call @atli_fn_even(%pred5) : (i64) -> i64
      scf.yield %call6 : i64
    }
    return %case2 : i64
  }
  func.func @atli_fn_main() -> i64 {
    ...
    %call1 = func.call @atli_fn_even(%c0) : (i64) -> i64
    return %call1 : i64
  }
