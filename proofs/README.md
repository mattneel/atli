...
| L3 | Effectful progress (§8.1) + effect-closed corollary | Qed | Sprint 15 |
| L4 | Preservation (§8.2) with row/bound order components | Qed | Sprint 15 |
...
| L8 | Solver/certificate soundness (§7.2/§7.3) | Qed | Sprint 15 |
...
Current admitted theorem count: 1 (`boundedness_soundness`). L6/L9/L10 remain SPI, not
`Admitted`, because the resource/heap/concurrent relations they quantify over are not yet
in the scaffold. L7 now has the missing frame-step infrastructure and bridge witnesses; it
is the single counted runway theorem.
