...
| L3 | Effectful progress (§8.1) | Admitted; effect-closed corollary Qed from L3 | Future metatheory sprint |
...
Current admitted theorem count: 4 (`progress`, `preservation`, `boundedness_soundness`,
